...
@Component({
  selector: 'app-revendedor-perfil',
  templateUrl: './revendedor-perfil.component.html',
  styleUrls: ['./../../../../../app/app.component.css']
})
export class RevendedorPerfilComponent implements OnInit {
...
files: File[] = [];
  ...
  image: SafeUrl = "../assets/img/kal-visuals-square.jpg";
